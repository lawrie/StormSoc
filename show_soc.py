...
class ShowSoC(SoCWrapper):
    ...
    def elaborate(self, platform):
        ...
        self.hf = HyperFlash(pins=super().get_hflash(m, platform), init_latency=16)
        self._decoder.add(self.hf.data_bus, addr=self.hf_base)
...
if __name__ == "__main__":
    ...
    platform.build(ShowSoC(), do_program=True)
